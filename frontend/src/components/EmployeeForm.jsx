        ...
        {message && (
          <motion.div
            ...
            className={`mb-4 p-3 rounded-lg ${
              message.includes('success') ? 'bg-emerald-500/20 text-emerald-200 border border-emerald-500/30' : 'bg-amber-500/20 text-amber-200 border border-amber-500/30'
            }`}
          >
            {message}
          </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-4 pt-4">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="btn-primary flex-1 disabled:scale-100"
            >
